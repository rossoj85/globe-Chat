...
//   // console.log('NEW MESSAGE LIST MOUNTED')
    const recipientId = Number(props.match.params.recipientId); // because it's a string "1", not a number!
...
//     // console.log(filteredMessages)
    ...
    return (
      ...
      <NewMessageEntry recipientId={recipientId} isDM={true}/>
      </div>
    );
}
...
export default connect(mapState)(DirectMessagesList)